                ...
                <div className="panel panel-default">
                  <div className="panel-heading">
                    ...
                    <div className="panel-body">
                        ...
                        <div className="row">
                          <div className="col-sm-6">  <button className="btn btn-primary" onClick={this.onSubmit}>Submit</button></div>
                      <div className="col-sm-2"><h5 style={succesStyle}>Success!</h5> </div>
                        </div>
                    </div>
                </div>
            </div>
